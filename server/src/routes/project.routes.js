...
router.get("/:projectId/search-users", requireProjectAccess(["Admin", "Member"]), asyncHandler(searchUsers));
...
router.post("/:projectId/members", requireProjectAccess(["Admin", "Member"]), validate(memberSchema), asyncHandler(addMember));
