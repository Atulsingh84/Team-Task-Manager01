                    ...
                    <td>
                      <div className="avatar-group">
                        {project.members.slice(0, 4).map((member) => (
                          <Avatar key={member._id} name={member.user.name} />
                        ))}
                      </div>
                    </td>
                    <td><Badge variant="success">In Progress</Badge></td>
      ...
      <Card>
        ...
        <CardContent>
          <form className="project-form" onSubmit={submitProject}>
            ...
            <Textarea placeholder="Description" value={projectForm.description} onChange={(event) => setProjectForm({ ...projectForm, description: event.target.value })} />
            <Button type="submit">
              <Plus size={16} />
              Create project
            </Button>
